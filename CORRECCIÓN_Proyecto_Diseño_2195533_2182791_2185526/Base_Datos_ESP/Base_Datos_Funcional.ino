...
const int pinSalida = 15; // Número del pin de salida (antes 22)
...
const int humsuelo = 8;    // Número del pin del sensor de humedad del suelo (antes 33)
...
const int Sensor_h = 9; // Pin del sensor de humedad (antes 32)
